...
export function Navbar2() {
  ...
  return (
    <section
      id="relume"
      className="sticky top-0 z-[999] flex w-full items-center border-b border-border-primary bg-background-primary lg:min-h-18 lg:px-[5%]"
    >
