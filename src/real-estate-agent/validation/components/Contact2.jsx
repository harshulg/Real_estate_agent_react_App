      ...
      <div className="container max-w-lg">
        <div className="mx-auto mb-8 w-full max-w-lg text-center md:mb-10 lg:mb-12">
          ...
          <p className="md:text-md">
            Please submit your documents for validation below.
          </p>
        </div>
          ...
          <div className="grid w-full items-center py-3 md:py-4">
            ...
            <RadioGroup className="grid grid-cols-2 gap-x-6 gap-y-3.5">
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="Individual User" id="#first_choice" />
                <Label htmlFor="#first_choice">Individual User</Label>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="#third_choice">Real Estate Agent</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#fourth_choice" />
                <Label htmlFor="#fourth_choice">Property Developer</Label>
              </div>
              <div className="flex items-center space-x-2">
